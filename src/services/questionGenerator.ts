import { Question, QuestionCategory, Difficulty, ExamTrack } from '../types/game';
...
export const CURATED_PYQS: PyqTemplate[] = [
  {
    ...
    explanation:
      'BDF (B+2=D, D+2=F), HJL (+2, +2), NPR (+2, +2). In TVZ: T+2=V, but V+4=Z. Hence TVZ is the odd cluster.',
  },
  {
  ...
  },
  {
    ...
    explanation:
      '16^(x-1) = [2^4]^(x-1) = 2^(4x - 4). Equating exponents: x + 2 = 4x - 4 => 3x = 6 => x = 2.',
  },
  {
    ...
    explanation:
      'Favorable outcomes for sum 8: (2,6), (3,5), (4,4), (5,3), (6,2) = 5 outcomes. Total = 36. Probability = 5/36.',
  },
  {
    ...
    options: ['156 m²', '140 m²', '164 m²', '148 m²'],
    correctIndex: 0,
    category: 'spatial_reasoning',
    difficulty: 'medium',
    examTrack: 'gate',
    ...
    explanation:
      'Outer dimensions = (20 + 4) × (15 + 4) = 24 × 19 = 456 m². Inner area = 20 × 15 = 300 m². Walkway area = 456 - 300 = 156 m².',
  },
  {
    ...
    options: ['10 hrs', '12 hrs', '8 hrs', '24 hrs'],
    correctIndex: 1,
    category: 'time_work',
    difficulty: 'medium',
    examTrack: 'gate',
    ...
    explanation:
      'Net rate = 1/4 - 1/6 = (3 - 2)/12 = 1/12 tank/hr. Thus, 12 hours are required to fill the tank.',
  },
  {
    ...
    explanation:
      'Let boys = 3x and girls = 2x. 3x / (2x + 6) = 1 => 3x = 2x + 6 => x = 6. Number of boys = 3 × 6 = 18.',
  },
  {
    ...
    explanation:
      'log₁₀[x(x - 3)] = 1 => x² - 3x = 10 => x² - 3x - 10 = 0 => (x - 5)(x + 2) = 0. Since log requires x > 3, x = 5.',
  },
  {
    ...
    explanation:
      'Average speed for equal distance segments = 2xy / (x + y) = 2(40)(60) / (40 + 60) = 4800 / 100 = 48 km/h.',
  },
  {
    ...
    explanation:
      'Square side = √121 = 11 cm. Perimeter = 4 × 11 = 44 cm = 2πr. 2 × (22/7) × r = 44 => r = 7 cm. Area = πr² = (22/7) × 49 = 154 cm².',
  },
  {
    ...
    explanation:
      'Together in 1 day = 1/15 + 1/10 = 5/30 = 1/6. In 2 days = 2/6 = 1/3 done. Remaining = 2/3. A takes (2/3) / (1/15) = 10 days.',
  },
  {
  ...
  },
  {
    ...
    explanation:
      'Cyclicity of 7 is 4: 71 mod 4 = 3 => 7³ ends in 3. 6 always ends in 6. Cyclicity of 3 is 4: 65 mod 4 = 1 => 3¹ ends in 3. Product: 3 × 6 × 3 = 54 => unit digit 4.',
  },
  {
    ...
    explanation:
      'Total distance = 140 + 160 = 300m. Relative speed = 60 + 48 = 108 km/h = 108 × (5/18) = 30 m/s. Time = 300 / 30 = 10 seconds.',
  },
  {
  ...
  },
  {
    ...
    explanation:
      'Completing the square: f(x) = (x - 3)² + 4. Since (x - 3)² ≥ 0 for all real x, the minimum value is 4 (at x = 3).',
  },
  {
    ...
    explanation:
      'Tie the 2 specific books into 1 bundle: (5 items)! × (2 books internal arrangement)! = 120 × 2 = 240 ways.',
  },
  {
    ...
    explanation:
      'Let CP = 100. Marked Price MP = 140. Selling Price SP = 140 × 0.80 = 112. Net Profit = 112 - 100 = 12%.',
  },
  {
    ...
    explanation:
      'log₄(x) = log₂(x) / 2. So log₂(x) + (1/2)log₂(x) = (3/2)log₂(x) = 6 => log₂(x) = 4 => x = 2⁴ = 16.',
  },
  {
    ...
    options: ['4 hours', '3.6 hours', '4.5 hours', '5 hours'],
    correctIndex: 0,
    category: 'speed_distance',
    difficulty: 'easy',
    examTrack: 'cat',
    ...
    explanation:
      'Relative speed = 40 + 50 = 90 km/h. Time to meet = Total distance / Relative speed = 360 / 90 = 4 hours.',
  },
  {
    ...
    explanation:
      '|α - β| = 1 => (α - β)² = 1. Using identities: (α + β)² - 4αβ = 1 => b² - 4c = 1.',
  },
  {
    ...
    explanation:
      'Remaining liquid = Initial × (1 - x/V)ⁿ = 80 × (1 - 8/80)² = 80 × (0.9)² = 80 × 0.81 = 64.8 liters.',
  },
  {
    ...
    explanation:
      'Total seating arrangements = 5! = 120. Together arrangements = 4! × 2! = 24 × 2 = 48. Desired = 120 - 48 = 72.',
  },
  {
    ...
    options: ['14 1/3 days', '14 1/2 days', '15 days', '14 days'],
    correctIndex: 0,
    category: 'time_work',
    difficulty: 'hard',
    examTrack: 'cat',
    ...
    explanation:
      'Total work = LCM(12, 18) = 36 units. A = 3 units/day, B = 2 units/day. In 2 days = 5 units. 7 pairs (14 days) = 35 units. 1 unit remains, done by A in 1/3 day. Total = 14 1/3 days.',
  },
  {
  ...
  },
  {
    ...
    explanation:
      '(x + y + z)² = x² + y² + z² + 2(xy + yz + zx). Substituting: 12² = x² + y² + z² + 2(44) => 144 - 88 = 56.',
  },
  {
    ...
    explanation:
      'First term a = 12, common ratio r = 4/12 = 1/3. Sum S_∞ = a / (1 - r) = 12 / (1 - 1/3) = 12 / (2/3) = 18.',
  },
  {
  ...
  },
  {
    ...
    explanation:
      "Total ratio parts = 3 + 4 + 5 = 12 parts. B's share = (4/12) × ₹1,20,000 = (1/3) × 120000 = ₹40,000.",
  },
  {
  ...
  },
  {
    ...
    explanation:
      "When stationary, escalator steps = person's speed × time = 4 steps/s × 40s = 160 steps.",
  },
  {
    ...
    explanation:
      'Failed at least one = 100 - 10 = 90% appeared. P(E ∪ M) = 70% + 80% - P(Both) = 90% => P(Both) = 60%. 60% of Total = 144 => Total = 144 / 0.6 = 240.',
  },
  {
    ...
    explanation:
      'Space diagonal = √(l² + w² + h²) = √(12² + 9² + 8²) = √(144 + 81 + 64) = √289 = 17m.',
  },
  {
    ...
    explanation:
      'Inradius of right triangle r = (a + b - c) / 2 = (6 + 8 - 10) / 2 = 4 / 2 = 2 cm.',
  },
  {
    ...
    explanation:
      'Efficiency A:B = 2:1. Together efficiency = 3 units/day. Total work = 3 × 14 = 42 units. Time for A = 42 / 2 = 21 days.',
  },
  {
    ...
    explanation:
      '(-2)⁶ has an even exponent on the negative base, so (-2)⁶ = +64. For Quantity B, -2⁶ = -(2⁶) = -64. Quantity A is strictly greater.',
  },
  {
    ...
    explanation:
      '50 is (μ - 2σ) and 90 is (μ + 2σ). By the empirical 68-95-99.7 rule for normal distributions, approximately 95% of scores lie within 2 standard deviations.',
  },
  {
    text: 'GRE Quantitative Comparison:\nQuantity A: (2x + 3)²\nQuantity B: 4x² + 12x + 9',
    options: [
    ...
    explanation:
      '(2x + 3)² expands to 4x² + 2(2x)(3) + 9 = 4x² + 12x + 9. The two quantities are algebraically identical for all values of x.',
  },
  {
    ...
    explanation:
      'Adding a constant to every element shifts the mean but does not alter the dispersion or spread. The standard deviation remains unchanged at 4.',
  },
  {
    ...
    explanation:
      'Since (x - 1)(y - 1) > 0 for x, y > 1, expanding gives xy - x - y + 1 > 0 => xy + 1 > x + y => xy > x + y - 1. For x, y ≥ 2, xy > x + y, meaning (x + y)/(xy) < 1. Hence Quantity B is greater.',
  },
  {
    ...
    explanation:
      'Width = √(13² - 12²) = √(169 - 144) = √25 = 5. Area = length × width = 12 × 5 = 60.',
  },
  {
    ...
    explanation:
      'Circumference = 2πr = 10π => r = 5. Quantity A = 5, which is equal to Quantity B.',
  },
  {
    ...
    explanation:
      'P(A or B) = P(A) + P(B) - P(A ∩ B). For independent events, P(A ∩ B) = 0.4 × 0.5 = 0.2. So 0.4 + 0.5 - 0.2 = 0.70.',
  },
  {
    ...
    explanation:
      'n² + n = n(n + 1). As the product of two consecutive integers, one must be even, so the product is always divisible by 2. The remainder is always 0.',
  },
  {
    ...
    explanation:
      'Formula: (W₁ × D₁) / Output₁ = (W₂ × D₂) / Output₂ => (8 × 8) / 8 = (32 × D₂) / 32 => 8 = D₂. It takes 8 days.',
  },
  {
    ...
    explanation:
      'By the triangle inequality: |x + y| ≤ |x| + |y| < 3 + 2 = 5. Therefore |x + y| is strictly less than 5, so Quantity B is greater.',
  },
  {
    ...
    explanation:
      'Prime factorization: 360 = 2³ × 3² × 5¹. Number of divisors = (3 + 1)(2 + 1)(1 + 1) = 4 × 3 × 2 = 24.',
  },
  {
    ...
    explanation:
      'Perpendicular lines have slopes satisfying m₁ × m₂ = -1. Since m₁ = 2, m₂ = -1/2 = -0.5. Both quantities are equal.',
  },
  {
  ...
  },
  {
    ...
    explanation:
      'V_cylinder = πr²h. V_cone = (1/3)πr²h. 3 × V_cone = 3 × (1/3)πr²h = πr²h. The two quantities are equal.',
  },
  {
  ...
  },
  {
    ...
    options: ['24 mph', '25 mph', '24.5 mph', '26 mph'],
    correctIndex: 0,
    category: 'speed_distance',
    difficulty: 'easy',
    examTrack: 'gre',
  ...
  },
  {
    ...
    explanation:
      'Te = (to + 4tm + tp) / 6 = (3 + 4×6 + 15) / 6 = (3 + 24 + 15) / 6 = 42 / 6 = 7 days.',
  },
  {
    ...
    explanation:
      'Cost Slope represents additional direct cost incurred per unit reduction in time: Cost Slope = (Cc - Cn) / (Tn - Tc).',
  },
  {
    ...
    explanation:
      'Total Float is the maximum time an activity can be delayed without delaying project completion: TF = LF - EF = LS - ES.',
  },
  {
    ...
    explanation:
      'Free Float is the portion of total float within which an activity can be delayed without delaying the early start of subsequent activities: FF = ES_successor - EF_activity.',
  },
  {
    ...
    explanation:
      'Six Sigma quality performance corresponds to 3.4 defects per million opportunities (accounting for a 1.5σ process shift).',
  },
  {
    ...
    explanation:
      'The Deming Cycle (Shewhart Cycle) is PDCA: Plan (identify goals), Do (implement), Check (evaluate results), Act (standardize or adjust).',
  },
  {
    ...
    explanation:
      "The Pareto Principle posits that roughly 80% of consequences come from 20% of the causes (focusing on the 'vital few' over the 'trivial many').",
  },
  {
    ...
    explanation:
      'Scoping defines the Terms of Reference (ToR), key environmental concerns, and spatial/temporal boundaries for the EIA report.',
  },
  {
    ...
    explanation:
      'Engineers hold paramount the safety, health, and welfare of the public. Whistleblowing is justified to prevent imminent public harm after internal channels are exhausted.',
  },
  {
    ...
    explanation:
      'TQM emphasizes customer satisfaction, continuous process improvement (Kaizen), and widespread employee participation across all levels.',
  },
  {
    text: 'An activity has Early Start = Day 5, Late Start = Day 9, and Duration = 6 days. What is its Total Float?',
    options: ['4 days', '6 days', '14 days', '1 day'],
    correctIndex: 0,
    category: 'ethics_project_mgmt',
    difficulty: 'easy',
    examTrack: 'ese',
  ...
  },
  {
    ...
    explanation:
      'A Conflict of Interest occurs when personal, financial, or external loyalties impair or appear to compromise impartial engineering judgment.',
  },
  {
    ...
    explanation:
      'LCC sums total costs of ownership: concept/R&D + capital procurement + operation & maintenance + decommissioning & disposal.',
  },
  {
    ...
    explanation:
      'The Critical Path controls project duration; any delay in activities along this path directly delays project completion.',
  },
  {
    ...
    options: ['15% to 22%', '45% to 55%', '70% to 80%', '5% to 8%'],
    correctIndex: 0,
    category: 'engineering_aptitude',
    difficulty: 'medium',
    examTrack: 'ese',
    ...
    explanation:
      'Typical monocrystalline and polycrystalline commercial solar PV modules operate with conversion efficiencies between 15% and 22%.',
  },
  {
    ...
    options: ['ISO 14001', 'ISO 9001', 'ISO 45001', 'ISO 27001'],
    correctIndex: 0,
    category: 'engineering_aptitude',
    difficulty: 'easy',
    examTrack: 'ese',
    ...
    explanation:
      'ISO 14001 sets criteria for an Environmental Management System. (ISO 9001 is Quality, ISO 45001 is Occupational Health & Safety).',
  },
  {
    ...
    explanation:
      'If NPV > 0 at the designated discount rate (MARR), the project yields returns in excess of capital cost and adds positive economic value.',
  },
  {
    ...
    explanation:
      'In Third Angle projection (common in North America), the projection plane is assumed to be transparent and positioned between the observer and the object.',
  },
  {
    ...
    options: ['5,000 units', '3,333 units', '4,000 units', '2,500 units'],
    correctIndex: 0,
    category: 'engineering_aptitude',
    difficulty: 'medium',
    examTrack: 'ese',
    ...
    explanation:
      'Break-even quantity Q = Fixed Cost / (Selling Price - Variable Cost) = 1,00,000 / (50 - 30) = 1,00,000 / 20 = 5,000 units.',
  },
  {
    ...
    explanation:
      "Heinrich's Law (1-29-300 rule) states that for every major injury, there are 29 minor injuries and 300 no-injury incidents (near misses).",
  },
  {
    ...
    explanation:
      "Sum of present ages = 64 - (4 + 4) = 56 years. Ratio parts = 5 + 2 = 7. Son's age = (2/7) × 56 = 16 years.",
  },
  {
  ...
  },
  {
    ...
    options: ['15m East', '10m North', '25m East', '15m West'],
    correctIndex: 0,
    category: 'logic',
    difficulty: 'easy',
    examTrack: 'placement',
    ...
    explanation:
      '10m North followed by 10m South cancels the vertical displacement. He is displaced 15m directly East.',
  },
  {
  ...
  },
  {
    ...
    explanation:
      "Mother's only brother is Ravi's maternal uncle. Maternal uncle's daughter is Ravi's cousin.",
  },
  {
    ...
    explanation:
      'Gain % = [Error / (True Value - Error)] × 100 = [100 / 900] × 100 = (1/9) × 100 = 11.11%.',
  },
  {
    ...
    explanation:
      'Relative speed in same direction = 72 - 18 = 54 km/h = 54 × (5/18) = 15 m/s. Time = 200 / 15 = 13.33 seconds (40/3 s).',
  },
  {
    ...
    explanation:
      'Doubling means interest earned = P in 5 years (rate = 20%). For 4 times, interest needed = 3P. Time = 3 × 5 = 15 years.',
  },
  {
    ...
    explanation:
      'Years: 2006 (1 odd day), 2007 (1), 2008 leap year (2), 2009 (1) = Total 5 odd days. Sunday + 5 days = Friday.',
  },
  {
    ...
    explanation:
      'Rate of leak = 1/8 - 1/10 = (5 - 4) / 40 = 1/40 cistern per hour. The leak empties the cistern in 40 hours.',
  },
  {
  ...
  },
  {
    ...
    explanation:
      'Speed of stream = (Downstream speed - Upstream speed) / 2 = (14 - 8) / 2 = 6 / 2 = 3 km/h.',
  },
  {
    ...
    explanation:
      'Pens ⊂ Books ⊂ Roads. Therefore All pens are roads (I is valid). As Pens ⊂ Roads, Some roads are pens (II is valid).',
  },
  {
    ...
    options: ['16.36 km/h', '20.00 km/h', '18.50 km/h', '15.00 km/h'],
    correctIndex: 0,
    category: 'speed_distance',
    difficulty: 'medium',
    examTrack: 'placement',
    ...
    explanation:
      'Harmonic mean of 3 equal segments = 3 / (1/10 + 1/20 + 1/30) = 3 / (6/60 + 3/60 + 2/60) = 3 / (11/60) = 180 / 11 = 16.36 km/h.',
  },
  {
    ...
    explanation:
      'Pattern: (previous term × 2) + 2. (3×2)+2=8, (8×2)+2=18, (18×2)+2=38, (38×2)+2=78, (78×2)+2 = 158.',
  },
  {
    ...
    options: ['5 5/11 min past 7', '5 3/11 min past 7', '6 min past 7', '5 7/11 min past 7'],
    correctIndex: 0,
    category: 'logic',
    difficulty: 'hard',
    examTrack: 'placement',
    ...
    explanation:
      'Angle = 180°. 30(7) - 5.5M = -180 => 210 + 180 = 5.5M => 390 = (11/2)M => M = 780 / 11 = 5 5/11 minutes past 7.',
  },
  {
    ...
    options: ['6 : 9 : 5', '4 : 6 : 5', '5 : 6 : 4', '6 : 8 : 5'],
    correctIndex: 0,
    category: 'arithmetic',
    difficulty: 'medium',
    examTrack: 'placement',
  ...
  },
  {
    ...
    explanation:
      "'LOGARITHM' has 9 distinct letters. Number of 4-letter permutations = 9P4 = 9 × 8 × 7 × 6 = 3,024.",
  },
  {
    text: 'If the cost price of 15 pens equals the selling price of 20 pens, what is the net loss percentage?',
    options: ['25.00%', '20.00%', '33.33%', '15.00%'],
    correctIndex: 0,
    category: 'percentages',
    difficulty: 'easy',
    examTrack: 'placement',
  ...
  },
  {
    ...
    explanation:
      "'LEADER' has 6 letters with 'E' repeating twice: Total permutations = 6! / 2! = 720 / 2 = 360.",
  },
  {
    ...
    explanation:
      'Equation I: (x - 3)(x - 4) = 0 => x = 3, 4. Equation II: (y - 4)(y - 5) = 0 => y = 4, 5. For x=3, x < y. For x=4, x ≤ y (4 = 4, 4 < 5). Hence x ≤ y.',
  },
  {
    ...
    explanation:
      'sin θ = (√2 - 1) cos θ. Rationalizing: cos θ - sin θ = cos θ - (√2 - 1) cos θ = (2 - √2) cos θ = √2(√2 - 1) cos θ = √2 sin θ.',
  },
  {
    ...
    explanation:
      'Pattern is n³ + 3: 1³+3=4, 2³+3=11, 3³+3=30, 4³+3=67, 5³+3=128, 6³+3 = 216 + 3 = 219.',
  },
  {
  ...
  },
  {
    ...
    explanation:
      'Effective compound interest rate for 2 years at 10% = 10 + 10 + (10×10)/100 = 21%. CI = ₹10,000 × 21% = ₹2,100.',
  },
  {
    text: 'Simplify: (480 ÷ 16) × 12 - 25% of 600 = ?',
    options: ['210', '220', '195', '200'],
    correctIndex: 0,
    category: 'arithmetic',
    difficulty: 'easy',
    examTrack: 'banking',
  ...
  },
  {
    ...
    explanation:
      'Each term doubles the previous: 6×2=12, 12×2=24, 24×2=48, 48×2=96, 96×2=192 (not 190), 192×2=384. Thus 190 is wrong.',
  },
  {
    ...
    explanation:
      'Milk part = 4/5 + 3/5 = 7/5. Water part = 1/5 + 2/5 = 3/5. Ratio = (7/5) : (3/5) = 7 : 3.',
  },
  {
    ...
    explanation:
      "New count = 25 people. Total increase = 25 × 0.40 kg = 10 kg. Teacher's weight = 35 + 10 = 45 kg.",
  },
  {
    ...
    explanation:
      'SI = (P × R × T) / 100 => 1800 = (P × 12 × 3) / 100 => 1800 = 36P / 100 => P = (1800 × 100) / 36 = ₹5,000.',
  },
  {
    ...
    explanation:
      'Girls = 40% of 60 = 24. If boys become 70%, girls remain 30% of new total. New total = 24 / 0.30 = 80. Boys to add = 80 - 60 = 20.',
  },
  {
    ...
    options: ['12 days', '10 days', '9 days', '15 days'],
    correctIndex: 0,
    category: 'time_work',
    difficulty: 'easy',
    examTrack: 'banking',
    ...
    explanation:
      'Efficiency ratio A:B = 1.5 : 1 = 3 : 2. Time ratio A:B = 2 : 3. Since B takes 18 days, A takes (2/3) × 18 = 12 days.',
  },
  {
  ...
  },
  {
    ...
    options: ['14.28%', '12.50%', '15.00%', '10.00%'],
    correctIndex: 0,
    category: 'percentages',
    difficulty: 'hard',
    examTrack: 'banking',
    ...
    explanation:
      'Interest for 2 years = 10,200 - 8,500 = 1,700 => 1 year interest = 850. Interest for 3 years = 2,550. Principal = 8,500 - 2,550 = ₹5,950. Rate = (850 / 5950) × 100 = 14.28%.',
  },
  {
    ...
    options: ['₹12,600', '₹14,000', '₹11,500', '₹13,200'],
    correctIndex: 0,
    category: 'arithmetic',
    difficulty: 'hard',
    examTrack: 'banking',
    ...
    explanation:
      "A: 20000×6 + 15000×6 = 120000 + 90000 = 210,000. B: 30000×6 + 35000×6 = 180000 + 210000 = 390,000. Ratio = 21:39 = 7:13. A's share = (7/20) × 36000 = ₹12,600.",
  },
  {
  ...
  },
  {
    ...
    explanation:
      'Since x% of y = y% of x, 64% of 450 is identical to 45% of 640! Sum = 2 × (0.45 × 640) = 2 × 288 = 576.',
  },
  {
    ...
    explanation:
      'Net rate = 1/10 + 1/15 - 1/20 = (6 + 4 - 3)/60 = 7/60 tank/hour. Time required = 60/7 = 8 4/7 hours.',
  },
  {
    ...
    explanation:
      'V₁ = πr²h. V₂ = π(2r)²(h/2) = π(4r²)(h/2) = 2πr²h = 2 × V₁. The volume is doubled.',
  },
];
...
export function generateQuestion(difficulty: Difficulty, track: ExamTrack = 'all'): Question {
  ...
  if (matchingCurated.length === 0 && track !== 'all') {
    matchingCurated = CURATED_PYQS.map((q, idx) => ({ q, idx })).filter(
      ({ q }) => q.examTrack === track
    );
  }
